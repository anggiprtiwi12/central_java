...
const DoneProduk = () => {
  ...
  const filteredData = riwayatData.filter((data) => data.status === "Selesai");

  const cardData = [
    {
      title: "Total Produk Selesai",
        ...
        <div className="container mx-auto px-4 flex">
          ...
          <div className="flex-1">
            <div className="mb-4 flex justify-between items-center">
              <h2 className="text-2xl font-bold">Done Produk</h2>
                ...
                <tbody>
                  {filteredData.map((data, index) => (
                    <tr key={index}>
                      ...
                      <td className="border-b py-2 px-4 text-green-500">{data.status}</td>
